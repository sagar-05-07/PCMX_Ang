...
import { AddVisitComponent } from 'src/app/pages/rcm-login/visits/grid-view/add-visit/add-visit.component';
import { VisitMergeComponent } from 'src/app/pages/rcm-login/visits/grid-view/visit-merge/visit-merge.component';

@Component({
  selector: 'app-pro-grid-view',
  templateUrl: './pro-grid-view.component.html',
  styleUrl: './pro-grid-view.component.scss'
})
export class ProGridViewComponent {
