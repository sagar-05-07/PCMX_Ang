...
@Component({
  selector: 'app-pro-report-visits',
  templateUrl: './pro-report-visits.component.html',
  styleUrl: './pro-report-visits.component.scss'
})
export class ProReportVisitsComponent {
