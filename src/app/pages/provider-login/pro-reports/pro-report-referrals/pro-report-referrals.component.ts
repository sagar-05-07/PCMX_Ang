...
@Component({
  selector: 'app-pro-report-referrals',
  templateUrl: './pro-report-referrals.component.html',
  styleUrl: './pro-report-referrals.component.scss'
})
export class ProReportReferralsComponent {
