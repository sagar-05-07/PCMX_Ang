...
import { PatientPopComponent } from '../../rcm-login/patient-pop/patient-pop.component';

@Component({
  selector: 'app-partner-requests',
  templateUrl: './partner-requests.component.html',
  styleUrl: './partner-requests.component.scss'
})
export class PartnerRequestsComponent {
