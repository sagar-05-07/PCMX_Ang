...
@Component({
  ...
  templateUrl: './law-dashboard.component.html',
  styleUrl: './law-dashboard.component.scss'
})
export class LawDashboardComponent {
  ngOnInit(): void {
    this.billingByType();
    // this.visitsByStatus();
    // this.claimsbyStatus();
  ...
  billingByType(): void {
    const chartOptions2: Highcharts.Options = {
      ...
      title: {
        text: 'New Patient Registration by Month (2024)',
        style: {
