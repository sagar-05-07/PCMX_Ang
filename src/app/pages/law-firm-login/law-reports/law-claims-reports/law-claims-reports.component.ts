...
@Component({
  selector: 'app-law-claims-reports',
  templateUrl: './law-claims-reports.component.html',
  styleUrl: './law-claims-reports.component.scss'
})
export class LawClaimsReportsComponent {
  ...
  openManageGridDialog() {
    let headers = [
      { Name: 'Claim ID', IsSelected: true },
      { Name: 'Patient ID', IsSelected: true },
      { Name: 'Referral ID', IsSelected: true },
      { Name: 'MED', IsSelected: true },
      { Name: 'AoB', IsSelected: true },
      { Name: 'LoP', IsSelected: true },
    ];
      ...
      series: [
        {
          ...
          data: [
            ...
            { name: 'Initiated', sliced: true, selected: true, y: 35.5 },
            { name: 'Deposit', sliced: true, selected: true, y: 45.5 },
            { name: 'Negotiated', sliced: true, selected: true, y: 35.5 },
            { name: 'Interim', sliced: true, selected: true, y: 19.0 },
            { name: 'Settled', y: 35.5 },
          ],
        },
      ],
  ...
  providerfunnel1(): void {
    const chartOptions21: Highcharts.Options = {
      ...
      title: {
        text: 'Monthly Claims in last 6 Months',
        style: {
    ...
    Highcharts.chart('container8', chartOptions21);
  }
