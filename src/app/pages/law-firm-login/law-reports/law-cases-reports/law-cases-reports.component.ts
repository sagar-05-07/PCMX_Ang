...
@Component({
  selector: 'app-law-cases-reports',
  templateUrl: './law-cases-reports.component.html',
  styleUrl: './law-cases-reports.component.scss'
})
export class LawCasesReportsComponent {
