...
import { BreadcrumbService } from 'src/app/pages/breadcrumb.service';
import { UserService } from 'src/app/pages/login/user.service';
import { PatientPopComponent } from 'src/app/pages/rcm-login/patient-pop/patient-pop.component';
import { AdmnProviderSpecialtyComponent } from 'src/app/pages/super-admin/admin-provider/admn-provider-specialty/admn-provider-specialty.component';
import { GridProviderComponent } from 'src/app/pages/super-admin/admin-provider/grid-provider/grid-provider.component';
import { NetworkDialogComponent } from 'src/app/pages/super-admin/admin-provider/network-dialog/network-dialog.component';
import { ProviderdialogComponent } from 'src/app/pages/super-admin/admin-provider/providerdialog/providerdialog.component';
import { InsuranceDialogComponent } from 'src/app/pages/super-admin/rcm-accounts/insurance-dialog/insurance-dialog.component';
import { GridColumnComponent } from 'src/app/shared/grid-column/grid-column.component';

@Component({
  selector: 'app-law-providers',
  templateUrl: './law-providers.component.html',
  styleUrl: './law-providers.component.scss'
})
export class LawProvidersComponent {
