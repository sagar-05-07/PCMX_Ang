...
@Component({
  selector: 'app-analytics-providers',
  templateUrl: './analytics-providers.component.html',
  styleUrl: './analytics-providers.component.scss',
})
export class AnalyticsProvidersComponent {
  ...
  networksByState(): void {
    const chartOptions: Highcharts.Options = {
      ...
      title: {
        text: 'Provider Distribution  by State',
        style: {
          fontSize: '14px', // Adjust title font size
