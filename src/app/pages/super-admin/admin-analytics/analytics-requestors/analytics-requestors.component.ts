...
@Component({
  selector: 'app-analytics-requestors',
  templateUrl: './analytics-requestors.component.html',
  styleUrl: './analytics-requestors.component.scss',
})
export class AnalyticsRequestorsComponent implements OnInit {
  ...
  billingByType(): void {
    const chartOptions2: Highcharts.Options = {
      ...
      title: {
        text: 'New Law Firm Registration by Month (2024)',
        style: {
  ...
  networksByState(): void {
    const chartOptions: Highcharts.Options = {
      ...
      title: {
        text: 'Law Firm Distribution  by State',
        style: {
          fontSize: '14px', // Adjust title font size
  ...
  activeversusDormant(): void {
    const chartOptions: Highcharts.Options = {
      ...
      title: {
        text: 'Ageing Analysis of Settlement Period',
        style: {
          fontSize: '14px',
          fontWeight: 'bold',
        },
