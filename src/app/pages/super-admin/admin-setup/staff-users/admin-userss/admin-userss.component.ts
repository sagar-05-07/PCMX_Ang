...
@Component({
  ...
  templateUrl: './admin-userss.component.html',
  styleUrl: './admin-userss.component.scss'
})
export class AdminUserssComponent {
  ...
  openEditDialog() {
    let dialogRef = this.dialog.open(AdminAddUserComponent, {
