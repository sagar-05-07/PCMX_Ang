...
export class AdminRolesComponent {
  ...
  // }
  onpermclick() {
    this.router.navigate(['super-admin/setup/staff-users/roles/admin-permissions']);
  }


  public openspecialpermissions(id: any) {
    console.log('jkhksbdjk');
    let dialogRef = this.dialog.open(AdminSpecialPermissionsComponent, {
      data: id,
      height: 'auto',
      width: '650px',
    });
