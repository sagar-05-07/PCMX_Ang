...
@Component({
  selector: 'app-add-lawfirm',
  templateUrl: './add-lawfirm.component.html',
  styleUrl: './add-lawfirm.component.scss'
})
export class AddLawfirmComponent {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddLawfirmComponent>,
