...
import { AddPatientsComponent } from 'src/app/pages/rcm-login/patients/add-patients/add-patients.component';
import { PatientGridColumnComponent } from 'src/app/pages/rcm-login/patients/patient-grid-column/patient-grid-column.component';
