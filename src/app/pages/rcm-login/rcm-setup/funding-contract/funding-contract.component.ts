...
import { AddFundingContractComponent } from './add-funding-contract/add-funding-contract.component';
import { FileUploadComponent } from 'src/app/shared/file-upload/file-upload.component';
import { SingleFileUploadComponent } from 'src/app/shared/single-file-upload/single-file-upload.component';

@Component({
  selector: 'app-funding-contract',
  templateUrl: './funding-contract.component.html',
  styleUrl: './funding-contract.component.scss'
})
