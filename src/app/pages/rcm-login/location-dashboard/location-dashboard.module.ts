...
import { ProviderAnalyticsComponent } from '../providers-dashboard/provider-analytics/provider-analytics.component';

const routes: Routes = [

    { path: '', redirectTo: 'radar', pathMatch: 'full' },

    { path: 'radar', component: ProviderRadarComponent },
    { path: 'analytics', component: ProviderAnalyticsComponent },
