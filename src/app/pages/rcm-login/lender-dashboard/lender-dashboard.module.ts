...
import { ProviderRadarComponent } from '../providers-dashboard/provider-radar/provider-radar.component';
import { LenderAnalyticsComponent } from './lender-analytics/lender-analytics.component';
import { LenderOverviewComponent } from './lender-overview/lender-overview.component';
import { FundingContractComponent } from '../rcm-setup/funding-contract/funding-contract.component';
import { BatchesComponent } from '../rcm-funds/batches/batches.component';
import { InnerClaimsComponent } from '../inner-claims/inner-claims.component';
import { LenderFundingComponent } from './lender-funding/lender-funding.component';
import { LenderPaybackComponent } from './lender-payback/lender-payback.component';

const routes: Routes = [

    { path: '', redirectTo: 'analytics', pathMatch: 'full' },

    { path: 'analytics', component: LenderAnalyticsComponent },
    { path: 'radar', component: LenderOverviewComponent },
    { path: 'contracts', component: FundingContractComponent },
    { path: 'batches', component: BatchesComponent },
    { path: 'claims', component: InnerClaimsComponent },
    ...
    {
        path: 'lender-funding',
        component: LenderFundingComponent,
        loadChildren: () =>
            import('./lender-funding/lender-funding.module').then((m) => m.LenderFundingModule),
    },
    {
        path: 'lender-payback',
        component: LenderPaybackComponent,
        loadChildren: () =>
            import('./lender-payback/lender-payback.module').then((m) => m.LenderPaybackModule),
    },
]
...
@NgModule({
    ...
    declarations: [
        ...
        LenderAnalyticsComponent,
        LenderOverviewComponent,
        LenderFundingComponent,
        LenderPaybackComponent
    ]
})
