...
@Component({
  selector: 'app-radar-patients',
  templateUrl: './radar-patients.component.html',
  styleUrl: './radar-patients.component.scss'
})
export class RadarPatientsComponent {
  ...
  billingByType(): void {
    ...
    Highcharts.chart('container51', chartOptions2);
  }
  visitsByStatus(): void {
    ...
    Highcharts.chart('container52', chartOptions21);
  }
  claimsbyStatus(): void {
    const chartOptions21: Highcharts.Options = {
      chart: {
    ...
    Highcharts.chart('container53', chartOptions21);
  }
  networksByState(): void {
    const chartOptions: Highcharts.Options = {
      ...
      title: {
        text: 'Referral Distribution  by States',
        style: {
          fontSize: '14px', // Adjust title font size
    ...
    Highcharts.chart('container54', chartOptions);
  }
  activeversusDormant(): void {
    const chartOptions: Highcharts.Options = {
      ...
      title: {
        text: 'Patients Distribution by Types',
        style: {
          fontSize: '14px', // Adjust title font size
          fontWeight: 'bold', // Adjust title font weight
        },
    ...
    Highcharts.chart('container55', chartOptions);
  }
}