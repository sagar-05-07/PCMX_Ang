...
import { Orientation } from '@syncfusion/ej2-angular-schedule';
import { CalendarEvent, CalendarEventTimesChangedEvent } from 'angular-calendar';
import { startOfDay, subDays, addDays, endOfMonth, addHours, isSameDay, isSameMonth } from 'date-fns';
import { Subject } from 'rxjs';
import { ActionDialogComponent } from 'src/app/pages/super-admin/rcm-accounts/visits/action-dialog/action-dialog.component';
import { ScheduleActionDialogComponent } from 'src/app/pages/super-admin/rcm-accounts/visits/schedule-action-dialog/schedule-action-dialog.component';
...
export class CalenderViewComponent implements OnInit {
  ...
  icons = [
    { name: 'account_box', tooltip: 'Liaisons' },
    { name: 'add_box', tooltip: 'Patient Intake' },
    // { name: 'verified_user', tooltip: 'Authorization' },
    { name: 'group', tooltip: 'Case Manager' },
    { name: 'event', tooltip: 'Scheduling' },
    // { name: 'health_and_safety', tooltip: 'Patient Care' },
    { name: 'receipt_long', tooltip: 'Claim' },
    { name: 'attach_money', tooltip: 'Funds' },
    { name: 'collections', tooltip: 'Collection' },
    { name: 'business', tooltip: 'Leadership' },
