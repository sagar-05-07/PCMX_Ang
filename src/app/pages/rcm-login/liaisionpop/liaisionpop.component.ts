...
@Component({
  selector: 'app-liaisionpop',
  templateUrl: './liaisionpop.component.html',
  styleUrl: './liaisionpop.component.scss'
})
export class LiaisionpopComponent {
    ...
    constructor(
      public dialogRef: MatDialogRef<LiaisionpopComponent>,
