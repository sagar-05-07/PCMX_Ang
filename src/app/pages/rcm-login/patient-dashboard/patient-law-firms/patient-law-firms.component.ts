...
@Component({
  selector: 'app-patient-law-firms',
  templateUrl: './patient-law-firms.component.html',
  styleUrl: './patient-law-firms.component.scss'
})
export class PatientLawFirmsComponent {
